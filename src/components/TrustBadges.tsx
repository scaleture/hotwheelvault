...
export default function TrustBadges() {
  return (
    <div className="mx-4 sm:mx-12 mb-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 
      ...
      {BADGES.map((b, i) => (
        <div key={b.title} className="p-7 text-center relative group hover:bg-[#FF3D00]/5 transition-colors">
          ...
          <div className="text-4xl mb-3 group-hover:scale-110 transition-transform duration-300">{b.icon}</div>
